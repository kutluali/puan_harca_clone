...
class _FirstPageState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        width: double
            .infinity, // Yatayda tüm alanı kapla
        height: double
            .infinity, // Dikeyde tüm alanı kapla
        ...
        child: Stack(
          children: [
                ...
                children: [
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor:
                          Colors
                              .white, //Default olarak beyazdır zaten
                      foregroundColor:
                          Colors
                              .pinkAccent,
                      minimumSize: Size(
            ...
            Positioned(
              bottom: 30,
              left:
                  0, //Değerleri 0 vererek ortaladık.
              right: 0,
              child: Column(
                children: [
                  Icon(
